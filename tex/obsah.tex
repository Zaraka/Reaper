...
\section{Modifikace prohledávaného prostoru}
...
U¾ivatel by mìl být schopen v~aplikaci plnì pracovat s~projekty. Tedy mìl by mít mo¾nost vytvoøit nový projekt, nebo otevøít ji¾ vytvoøený. Spustit analýzu domény èi smazat ji¾ hotovou analýzu a hlavnì procházet výsledky analýzy. Toto se ukázalo jako nejslo¾itìj¹í problém, jeliko¾ u¾ivatel by mìl intuitivnì procházet grafem.
Zvolila jsem zpùsob zobrazení právì procházeného uzlu a jeho nejbli¾¹í okolí v~orientovaném grafu. Po poklikání na kterýkoliv vrchol v~zobrazení se tento vrchol a jeho nejbli¾¹í okolí otevøe.
...
\subsection{První èást - tvorba grafu}
...
\subsection{Druhá èást - (post processing)}
