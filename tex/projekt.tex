...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={Webový pavouk, HTML, analýza webových stránek, Jsoup}, %klicova slova v ceskem jazyce
  keywords.en={Web crawling, HTML, web page analysis, Jsoup}, %klicova slova v anglickem jazyce
  %Abstract
  ...
  Vytvoøená aplikace doká¾e analyzovat WWW stránky men¹ího rozsahu. Aplikace je u¾iteèná jako nástroj k sestavení struktury WWW stránek. }, % abstrakt v ceskem jazyce
  abstract.en={Výtah (abstrakt) práce v anglickém jazyce.}, % abstrakt v anglickem jazyce
  %Prohlaseni
  declaration={Prohla¹uji, ¾e jsem tuto bakaláøskou práci vypracoval samostatnì pod vedením pana ...},
  %Podekovani (nepovinne)
  acknowledgment={Velice dìkuji mému vedoucímu práce Ing. Radku Burgetovi, Ph.D  za motivaci, vedení a mou podporu. Dìkuji také Mgr. Franti¹u Trosteru za nápad na tento nástroj.} % nepovinne
}
